...
wait (2)
'V1 with reg expressions
Dim strOrderNo, strReplaced
strReplaced = WpfWindow("HPE MyFlight Sample Applicatio").WpfObject("Order 119 completed").GetVisibleText()
msgbox strReplaced
orderId = split(strReplaced, " ") (1)
msgbox orderId
reporter.ReportEvent micPass, "Your order number is:", orderId

'V2 with reg expressions object
strReplaced2 = WpfWindow("HPE MyFlight Sample Applicatio").WpfObject("Order 119 completed").GetVisibleText()
msgbox strReplaced2
Dim Match, RegExpObj, OrderId2
Set RegExpObj = new RegExp
RegExpObj.Global = True
RegExpObj.Pattern = "\d+"
For each Match in RegExpObj.Execute(strReplaced2)
OrderId2 = OrderId2 & Match.value
next
msgbox orderId2	
reporter.ReportEvent micPass, "Your order number is:", orderId2
